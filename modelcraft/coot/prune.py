...
class Model:
  ...
  def set_connections(self):
    for i in range(len(self.residues) - 1):
      ...
      if " CA " not in res1.atoms or " C  " not in res1.atoms: continue
      if " N  " not in res2.atoms or " CA " not in res2.atoms: continue
  ...
  def set_pepflip_peaks(self):
    ...
    def has_o_moving_peak(residue):
      if residue.next is None: return False
      if " O  " not in residue.atoms: return False
      ...
      for peak in peaks:
        point = peak[1]
        cd = distance(point, c)
        if cd < 1.09769614 or cd > 3.22217608: continue
        if angle(o, c, point) < 75.45064459: continue
        ca1d = distance(point, ca1)
        if ca1d < 0.66596873 or ca1d > 2.8910501: continue
        ca2d = distance(point, ca2)
        if ca2d < 2.23908466 or ca2d > 3.84813939: continue
        return True
      return False
    def has_n_moving_peak(residue):
      if residue.prev is None or not residue.prev.has_pepflip_peak: return False
      if " O  " not in residue.prev.atoms: return False
      o = residue.prev.atoms[" O  "].point
      ca = residue.atoms[" CA "].point
      for peak in peaks:
        point = peak[1]
        if distance(point, o)  > 0.52516368: continue
        if distance(point, ca) > 2.76397302: continue
        return True
      return False
    for residue in self.residues:
  ...
  def set_correctness(self):
    ...
    for res in self.residues:
      ...
      res.main_chain_correctness = predict(X_main, training_data["main"]["regressor.coefs_"], training_data["main"]["regressor.intercepts_"])
      if res.truncatable:
        ...
        res.side_chain_correctness = predict(X_side, training_data["side"]["regressor.coefs_"], training_data["side"]["regressor.intercepts_"])

  def set_chains(self):
    self.chains = {}
    for residue in self.residues:
      chain_id = residue.chain
      if chain_id not in self.chains: self.chains[chain_id] = Chain()
...
class TodoListWindow(gtk.Window):
  ...
  def __init__(self, title, categories, height = 600):
    ...
    if TodoListWindow.instance != None:
...
class TodoListFrame(gtk.Frame):
  ...
  def expand_contract(self, event_box, event):
    ...
    if self.expanded: self.contents.show()
    else: self.contents.hide()
    self.set_title_label()
  ...
  def init_list_store(self):
    types = [type(self.todos[0][name]) for name in self.columns] + [bool, object, object]
  ...
  def on_tree_view_selection(self, tree_view):
    if self.done_toggled_this_click: return
    ...
    if treeiter is not None:
      ...
      for frame in self.parent_window.frames:
        if self == frame or len(frame.todos) == 0: continue
...
def imolmapdiff_chooser(callback):
  imols = [i for i in molecule_number_list() if valid_model_molecule_qm(i)]
  imaps = [i for i in molecule_number_list() if valid_map_molecule_qm(i) and not map_is_difference_map(i)]
  imap_diffs = [i for i in molecule_number_list() if valid_map_molecule_qm(i) and map_is_difference_map(i)]
...
def prune(imol, imap, imap_diff,
          chains=True, chain_threshold="auto", max_chain_fraction=0.2, max_chain_length=20,
          residues=True, residue_threshold="auto", max_residue_fraction=0.2, remove_isolated_residues=True,
          sidechains=True, sidechain_threshold="auto", max_sidechain_fraction=0.2):
  ...
  if chains:
    ...
    for chain_id in sorted(model.chains, ):
      chain = model.chains[chain_id]
      if chain.correctness < chain_threshold and len(chain.residues) <= max_chain_length and deleted + len(chain.residues) <= max_deleted:
  ...
  if residues:
    ...
    if remove_isolated_residues:
      for residue in remaining:
        if residue.prev is not None and not residue.prev.delete: continue
        if residue.next is not None and not residue.next.delete: continue
        residue.delete = True
    for residue in remaining:
      if residue.delete:
